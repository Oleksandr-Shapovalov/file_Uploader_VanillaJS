...
var elementCreate = function elementCreate() {
  var _node$classList;
...
function upload(selector) {
  ...
  var preview = elementCreate("div", ["preview"]);
  var open = elementCreate("button", ["btn"], "open");
  var upload = elementCreate("button", ["btn", "primary"], "upload");
  ...
  var filesToDOM = function filesToDOM(files) {
    files.forEach(function (file) {
      ...
      reader.onload = function (e) {
        ...
        preview.insertAdjacentHTML("afterbegin", "<div class=\"preview__image\">\n          <div class=\"preview__remove\" data-name=\"".concat(file.name, "\">\n          &times;\n          </div>\n          <img src=\"").concat(src, "\" alt=\"").concat(file.name, "\" />\n           <div class=\"preview__info\">\n           <span>").concat(file.name, "</span>\n            <span>").concat(bytesToSize(file.size), "</span>\n           </div>\n          </div>"));
      };
  ...
  var changeHandler = function changeHandler(e) {
    var _e$target$files, _e$dataTransfer, _e$target$files2;

    if (!((_e$target$files = e.target.files) !== null && _e$target$files !== void 0 && _e$target$files.length) && e !== null && e !== void 0 && (_e$dataTransfer = e.dataTransfer) !== null && _e$dataTransfer !== void 0 && _e$dataTransfer.length) return;
    files = (_e$target$files2 = e.target.files) !== null && _e$target$files2 !== void 0 && _e$target$files2.length ? Array.from(e.target.files) : Array.from(e.dataTransfer.files);
    preview.innerHTML = "";
  ...
  var removeHandler = function removeHandler(e) {
    ...
    if (upload && !files.length) removeElementWithAnimation(upload, "removing", 350);
  };
  ...
  var uploadHandler = function uploadHandler(e) {
    preview.querySelectorAll(".preview__remove").forEach(function (el) {
      return el.remove();
    });
...
},{"@firebase/storage":"node_modules/@firebase/storage/dist/index.esm2017.js"}],"node_modules/firebase/app/dist/index.esm.js":[function(require,module,exports) {
"use strict";
...
},{"@firebase/app":"node_modules/@firebase/app/dist/esm/index.esm2017.js"}],"app.js":[function(require,module,exports) {
"use strict";
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, index) {
      ...
      uploadTask.on("state_changed", function (snapshot) {
        ...
        var block = blocks[index].querySelector(".preview__info_progress");
        ...
        (0, _storage.getDownloadURL)(uploadTask.snapshot.ref).then(function (downloadURL) {
          console.log("File  number ".concat(index + 1, " available at"), downloadURL);
        });
      });
    });
  }
});
},{"./upload.js":"upload.js","firebase/storage":"node_modules/firebase/storage/dist/index.esm.js","firebase/app":"node_modules/firebase/app/dist/index.esm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
